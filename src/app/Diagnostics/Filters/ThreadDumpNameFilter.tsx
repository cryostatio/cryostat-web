...
export const ThreadDumpNameFilter: React.FC<NameFilterProps> = ({ threadDumps, filteredNames, onSubmit }) => {
  ...
  const nameOptions = React.useMemo(() => {
    return threadDumps.map((r) => r.threadDumpId).filter((n) => !filteredNames.includes(n));
  }, [threadDumps, filteredNames]);
