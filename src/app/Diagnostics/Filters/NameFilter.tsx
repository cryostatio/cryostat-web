...
export const NameFilter: React.FC<NameFilterProps> = ({ heapDumps, filteredNames, onSubmit }) => {
  ...
  const nameOptions = React.useMemo(() => {
    return heapDumps.map((r) => r.heapDumpId).filter((n) => !filteredNames.includes(n));
  }, [heapDumps, filteredNames]);
