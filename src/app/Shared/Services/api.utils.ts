...
export const messageKeys = new Map([
  ...
  [
    NotificationCategory.TriggerCreated,
    {
      ...
      body: (evt) => `Smart Trigger ${evt.message.trigger.condition} in target ${evt.message.jvmId} was created.`,
    } as NotificationMessageMapper,
  ],
  [
    NotificationCategory.TriggerDeleted,
    {
      ...
      body: (evt) => `Smart Trigger ${evt.message.trigger.condition} in target ${evt.message.jvmId} was deleted.`,
    } as NotificationMessageMapper,
  ],
  [
