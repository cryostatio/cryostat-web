...
import { Notification, NotificationCategory } from './api.types';
export class NotificationService {
  ...
  problemsNotifications(): Observable<Notification[]> {
    return this.notifications().pipe(map((a) => a.filter(NotificationService.isProblemNotification)));
  }
...
const NotificationsInstance = new NotificationService();
