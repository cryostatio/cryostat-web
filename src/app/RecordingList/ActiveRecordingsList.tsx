...
import { Button, DataList, DataListAction, DataListCheck, DataListItem, DataListItemRow, DataListItemCells, DataListCell, DataToolbar, DataToolbarContent, DataToolbarItem, Dropdown, DropdownItem, DropdownPosition, KebabToggle, Text, TextVariants, Title } from '@patternfly/react-core';
        ...
        <DataListItemCells
          dataListCells={[
            ...
            <DataListCell key={`table-row-${props.index}-4`}>
              <a href={props.recording.reportUrl} target="_blank">{props.recording.reportUrl}</a>
            </DataListCell>,
