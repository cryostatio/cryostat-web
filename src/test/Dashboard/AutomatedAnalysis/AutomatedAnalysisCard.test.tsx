...
import { ActiveRecording, ArchivedRecording, automatedAnalysisConfigToRecordingAttributes, AutomatedAnalysisRecordingConfig, defaultAutomatedAnalysisRecordingConfig } from '@app/Shared/Services/Api.service';
import { CachedReportValue, FAILED_REPORT_MESSAGE, NO_RECORDINGS_MESSAGE, RuleEvaluation } from '@app/Shared/Services/Report.service';
...
it('renders empty recordings error view and creates recording when clicked', async () => {
    ...
    expect(requestSpy).toBeCalledWith(automatedAnalysisConfigToRecordingAttributes(defaultAutomatedAnalysisRecordingConfig));
});
