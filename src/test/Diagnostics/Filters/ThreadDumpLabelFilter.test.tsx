...
const mockAnotherThreadDumpLabels = [
  {
    key: 'anotherLabel',
    value: 'anotherValue',
  },
];
const mockThreadDumpLabelList = ['someLabel=someValue', 'anotherLabel=anotherValue'];
...
const mockAnotherThreadDump = {
  ...mockThreadDump,
  name: 'anotherThreadDump',
  metadata: { labels: mockAnotherThreadDumpLabels },
} as ThreadDump;
const mockThreadDumpWithoutLabel = {
  ...mockThreadDump,
  name: 'noLabelThreadDump',
  metadata: { labels: [] },
} as ThreadDump;
const mockThreadDumpList = [mockThreadDump, mockAnotherThreadDump, mockThreadDumpWithoutLabel];

const onLabelInput = jest.fn((_label) => {
  /**Do nothing. Used for checking renders */
});

describe('<ThreadDumpLabelFilter />', () => {
  ...
  it('should display label selections when text input is clicked', async () => {
    ...
    mockThreadDumpLabelList.forEach((label) => {
  ...
  it('should select a name when a name option is clicked', async () => {
    ...
    // ThreadDumpLabelFilter's parent rebuilds to close menu by default.
