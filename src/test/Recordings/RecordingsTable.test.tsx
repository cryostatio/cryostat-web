...
describe('<RecordingsTable />', () => {
  ...
  it('handles a nested table with sticky header', async () => {
    ...
    expect(container.getElementsByClassName('pf-v6-c-scroll-outer-wrapper').length).toBe(1);
    expect(container.getElementsByClassName('pf-v6-c-scroll-inner-wrapper').length).toBe(1);
  });
