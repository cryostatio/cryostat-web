...
const mockAnotherRecording = { ...mockRecording, name: 'anotherRecording', state: RecordingState.STOPPED } as ActiveRecording;

const onStateSelectToggle = jest.fn((state) => { /**Do nothing. Used for checking renders */});
